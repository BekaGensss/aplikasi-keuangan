...
@section('content')
    <h1 class="text-2xl font-bold mb-4">Daftar Pemasukan</h1>
    @if (session('success'))
    ...
    <div class="bg-white p-6 rounded-lg shadow mb-8">
        <h2 class="text-xl font-bold mb-4">Tambah Pemasukan Baru</h2>
        <form action="/pemasukan/tambah" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div><label for="jumlah" class="block text-gray-700 font-semibold mb-2">Jumlah</label><input type="number" name="jumlah" id="jumlah" class="w-full p-2 border border-gray-300 rounded-md" required min="0" step="any"></div>
            ...
            <div class="mt-4"><button type="submit" class="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700">Simpan Pemasukan</button></div>
        </form>
    </div>
    <div class="bg-white p-6 rounded-lg shadow">
        <h2 class="text-xl font-bold mb-4">Riwayat Pemasukan</h2>
                ...
                @foreach ($pemasukan as $item)
                    <tr>
                        ...
                        <td class="py-2 px-4 border-b border-gray-200 flex space-x-2">
                            <a href="/pemasukan/{{ $item->id }}/edit" class="bg-yellow-500 text-white px-3 py-1 text-xs rounded-md">Edit</a>
