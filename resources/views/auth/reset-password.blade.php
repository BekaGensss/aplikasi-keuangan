...
<head>
    ...
    <title>Atur Ulang Sandi - Aplikasi Keuangan</title>
    ...
    <div class="w-full max-w-4xl mx-auto rounded-3xl overflow-hidden soft-shadow flex">
        ...
        <div class="flex-1 bg-white p-8 sm:p-10 lg:p-12 rounded-3xl md:rounded-l-none animate-slideInRight">
            ...
            <form method="POST" action="{{ route('password.store') }}">
                ...
                <div class="mb-5 animate-fadeIn delay-300">
                    ...
                    <div class="relative">
                        ...
                        <x-text-input id="email" class="pl-12 pr-4 py-3 block w-full border border-gray-300 rounded-xl shadow-sm placeholder-gray-400 focus:ring-indigo-500 focus:border-indigo-500 transition duration-300"
                            type="email" name="email" :value="old('email', $request->email)" required autofocus autocomplete="username" placeholder="contoh@email.com" />
                    </div>
                    <x-input-error :messages="$errors->get('email')" class="mt-2" />
                </div>

                <div class="mb-5 animate-fadeIn delay-400">
                ...
                <div class="mb-6 animate-fadeIn delay-500">
                    ...
                    <div class="relative">
                        ...
                        <x-text-input id="password_confirmation" class="pl-12 pr-12 py-3 block w-full border border-gray-300 rounded-xl shadow-sm placeholder-gray-400 focus:ring-indigo-500 focus:border-indigo-500 transition duration-300"
                ...
                <div class="flex items-center justify-end mt-8 animate-fadeIn delay-600">
