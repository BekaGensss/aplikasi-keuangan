...
<head>
    ...
    <style>
        ...
        /* Custom animations for a smoother visual flow */
...
<body class="min-h-screen flex items-center justify-center p-4 sm:p-6 relative">
    ...
    <div class="w-full max-w-4xl mx-auto rounded-3xl overflow-hidden soft-shadow flex">
        ...
        <div class="flex-1 bg-white p-8 sm:p-10 lg:p-12 rounded-3xl md:rounded-l-none animate-slideInRight">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="mb-5 animate-fadeIn delay-300">
                ...
                <div class="mb-6 animate-fadeIn delay-400">
                    ...
                    <div class="relative">
                        ...
                        <input id="password" class="pl-12 pr-12 py-3 block w-full border border-gray-300 rounded-xl shadow-sm placeholder-gray-400 focus:ring-indigo-500 focus:border-indigo-500 transition duration-300"
                ...
                <div class="flex items-center justify-between mb-8 animate-fadeIn delay-500">
                    <label for="remember_me" class="flex items-center cursor-pointer">
                        <input id="remember_me" type="checkbox" class="rounded-md border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500 transition duration-150 ease-in-out" name="remember">
                        <span class="ml-3 text-sm text-gray-600 hover:text-gray-800">Ingat saya</span>
                    </label>

                    @if (Route::has('password.request'))
                        <a class="text-sm font-medium text-indigo-600 hover:text-indigo-800 hover:underline transition-colors duration-200" href="{{ route('password.request') }}">
                            Lupa password?
                        </a>
                    @endif
                </div>

                <div class="animate-fadeIn delay-600">
            ...
            @if (Route::has('register'))
                <p class="mt-8 text-center text-base text-gray-600 animate-fadeIn delay-700">
                    Belum punya akun?
                    <a href="{{ route('register') }}" class="font-bold text-indigo-600 hover:text-indigo-800 hover:underline transition-colors duration-200">
                        Daftar Akun Baru
                    </a>
                </p>
            @endif
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // Ikon SVG untuk tampilan sandi yang tersembunyi (mata dicoret)
            ...
            // Ikon SVG untuk tampilan sandi yang terlihat (mata utuh)
            ...
            togglePasswordBtn.addEventListener('click', function () {
                ...
                // Mengubah ikon berdasarkan tipe input
